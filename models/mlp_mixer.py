...
class MlpMixer(nn.Module):
    def __init__(self, num_classes, num_blocks, patch_size, hidden_dim, tokens_mlp_dim, channels_mlp_dim, image_size=256):
...
# num_classes, num_blocks, patch_size, hidden_dim, tokens_mlp_dim, channels_mlp_dim, image_size=32
...
if __name__ == "__main__":
    import torch
    rand_inp = torch.rand(64, 3, 256, 256)
    model = mixer_s16(num_classes=5)
    res = model(rand_inp)
    print(res.shape)
